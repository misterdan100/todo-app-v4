...
export const Sidebar = () => {
  ...
  return (
    <>
      <aside
        id="sidebar"
        className={`${asideOpen ? '' : 'hidden'} fixed z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75`}
        aria-label="Sidebar"
      >
              ...
              <ul className="space-y-2 pb-2">
                ...
                <li className="opacity-30">
                  ...
                  >
                    ...
                    <span className="ml-3 flex-1 whitespace-nowrap text-gray-400">Users</span>
                  </a>
                </li>
                ...
                <li className="opacity-30">
                  ...
                  >
                    ...
                    <span className="ml-3 flex-1 whitespace-nowrap text-gray-400">
                      Products
                    </span>
                  </a>
                </li>
      ...
      <div
        className={`${asideOpen ? '' : 'hidden'} lg:hidden bg-gray-900/25 backdrop-filter backdrop-blur-sm fixed inset-0 z-10`}
        id="sidebarBackdrop"
        // onClick={() => showAside(false)}
      >
      </div>
    </>
  )
